      ...
      <body>
        <div className="container-fluid bg-light position-relative shadow">
          <nav className="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0 px-lg-5">
            <a href="index.html" className="navbar-brand font-weight-bold text-secondary" style="font-size: 50px;">
            ...
            <div className="collapse navbar-collapse justify-content-between" id="navbarCollapse">
              <div className="navbar-nav font-weight-bold mx-auto py-0">
                ...
                <div className="nav-item dropdown">
                  <a href="index.html" className="nav-link dropdown-toggle" data-toggle="dropdown">Pages</a>
              ...
              <a href="index.html" className="btn btn-primary px-4">Join Class</a>
            </div>
          </nav>
        </div>
        ...
        <div className="container-fluid bg-primary px-0 px-md-5 mb-5">
          <div className="row align-items-center px-3">
            <div className="col-lg-6 text-center text-lg-left">
              ...
              <a href="index.html" className="btn btn-secondary mt-1 py-3 px-5">Learn More</a>
            </div>
          ...
          <div className="container">
            <div className="row align-items-center">
              ...
              <div className="col-lg-7">
                ...
                <a href="index.html" className="btn btn-primary mt-2 py-2 px-4">Learn More</a>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="col-lg-4 mb-5">
                <div className="card border-0 bg-light shadow-sm pb-2">
                  <img className="card-img-top mb-2" src="img/class-1.jpg" alt=""/>
                    ...
                    <a href="index.html" className="btn btn-primary px-4 mx-auto mb-4">Join Now</a>
                </div>
              </div>
              <div className="col-lg-4 mb-5">
                <div className="card border-0 bg-light shadow-sm pb-2">
          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-7 mb-5 mb-lg-0">
                ...
                <a href="index.html" className="btn btn-primary mt-4 py-2 px-4">Book Now</a>
              </div>
              <div className="col-lg-5">
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-md-6 col-lg-3 text-center team mb-5">
                <div className="position-relative overflow-hidden mb-4" style="border-radius: 100%;">
                  <img className="img-fluid w-100" src="img/team-1.jpg" alt="" />
                    <div
                      ...
                      <a className="btn btn-outline-light text-center mr-2 px-0" style="width: 38px; height: 38px;"
                        href="index.html"><i className="fab fa-twitter"></i></a>
                      <a className="btn btn-outline-light text-center mr-2 px-0" style="width: 38px; height: 38px;"
                        href="index.html"><i className="fab fa-facebook-f"></i></a>
                      <a className="btn btn-outline-light text-center px-0" style="width: 38px; height: 38px;"
                        href="index.html"><i className="fab fa-linkedin-in"></i></a>
                    </div>
                </div>
                <h4>Julia Smith</h4>
                <i>Music Teacher</i>
                ...
                <div className="card border-0 shadow-sm mb-2">
                  <img className="card-img-top mb-2" src="img/blog-1.jpg" alt="" />
                    <div className="card-body bg-light text-center p-4">
                      ...
                      <a href="index.html" className="btn btn-primary px-4 mx-auto my-2">Read More</a>
                    </div>
                </div>
              </div>
              <div className="col-lg-4 mb-4">
        ...
        <div className="container-fluid bg-secondary text-white mt-5 py-5 px-sm-3 px-md-5">
          <div className="row pt-5">
            <div className="col-lg-3 col-md-6 mb-5">
              <a href="index.html" className="navbar-brand font-weight-bold text-primary m-0 mb-4 p-0" style="font-size: 40px; line-height: 40px;">
                <i className="flaticon-043-teddy-bear"></i>
              ...
              <div className="d-flex justify-content-start mt-4">
                <a className="btn btn-outline-primary rounded-circle text-center mr-2 px-0"
                  style="width: 38px; height: 38px;" href="index.html"><i className="fab fa-twitter"></i></a>
                <a className="btn btn-outline-primary rounded-circle text-center mr-2 px-0"
                  style="width: 38px; height: 38px;" href="index.html"><i className="fab fa-facebook-f"></i></a>
                <a className="btn btn-outline-primary rounded-circle text-center mr-2 px-0"
                  style="width: 38px; height: 38px;" href="index.html"><i className="fab fa-linkedin-in"></i></a>
                <a className="btn btn-outline-primary rounded-circle text-center mr-2 px-0"
                  style="width: 38px; height: 38px;" href="index.html"><i className="fab fa-instagram"></i></a>
              </div>
            </div>
            <div className="col-lg-3 col-md-6 mb-5">
            ...
            <div className="col-lg-3 col-md-6 mb-5">
              ...
              <div className="d-flex flex-column justify-content-start">
                ...
                <a className="text-white mb-2" href="index.html"><i className="fa fa-angle-right mr-2"></i>About Us</a>
                <a className="text-white mb-2" href="index.html"><i className="fa fa-angle-right mr-2"></i>Our Classes</a>
                <a className="text-white mb-2" href="index.html"><i className="fa fa-angle-right mr-2"></i>Our Teachers</a>
                <a className="text-white mb-2" href="index.html"><i className="fa fa-angle-right mr-2"></i>Our Blog</a>
                <a className="text-white" href="index.html"><i className="fa fa-angle-right mr-2"></i>Contact Us</a>
              </div>
            </div>
            <div className="col-lg-3 col-md-6 mb-5">
          ...
          <div className="container-fluid pt-5" style="border-top: 1px solid rgba(23, 162, 184, .2);;">
            <p className="m-0 text-center text-white">
              &copy; <a className="text-primary font-weight-bold" href="index.html">Your Site Name</a>. All Rights Reserved. Designed
              by
        ...
        <a href="index.html" className="btn btn-primary p-3 back-to-top"><i className="fa fa-angle-double-up"></i></a>
